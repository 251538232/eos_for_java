...
//		Rpc rpc = new Rpc("http://api.eosnewyork.io:80");
		Rpc rpc = new Rpc("http://node2.liquideos.com:8888");
		
		Account account = rpc.getAccount("raowenbo2eos");
		System.out.println(account.toString());
		System.out.println("============= 转账EOS ===============");
		try {
			//eos转账
//			Transaction t1 = rpc.transfer("5J7Z6TYTWJRtkqrmA667BL4MbVDYTt4CF3bQLdJP3mkG3xySAL1","eosio.token", "mc1234555555","test12344444", "10.0000 EOS", "");
			//代币转账
